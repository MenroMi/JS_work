...
const double = a => a * 2; // один аргумент может без скобочек
// если тело функции можно описать в одну строку, и результат надо вернуть
// то можно опустить слово return
